...
namespace Activity_03
{
    internal class Program
    {
        ...
        public class StudentClass
        {
            ...
            {
                new Student { FirstName = "Arsal", LastName = "Ajmal", ID = 523, Year = GradeLevel.SecondYear, ExamScores = new List<int> { 99, 82, 81, 79 } },
            ...
            protected static int GetPercentile(Student s) // Fixed spelling from "GetPerecentile" to "GetPercentile"
            {
            ...
            public void QueryHighScores(int exams, int score)
            {
                ...
                {
                    // Fixed the syntax for Console.WriteLine
